        ...
        parts: [
          {
            ...
            metadata: {
              ...
              settings: {
                content: {
                  settings: {
                    content: '<a href="https://github.com/Azure-Samples/AI-Gateway/blob/main/labs/product-framework/product-framework.ipynb" target="_blank"><img src="https://raw.githubusercontent.com/Azure-Samples/AI-Gateway/refs/heads/main/images/product-framework-small.gif"/></a>'
                    markdownUri: null
                  }
                }
              }
